...
const Legendary = artifacts.require('./Legendary_v6.sol');
const Token = artifacts.require('./Token.sol');
const Rookie = artifacts.require('./Rookie_v6.sol');
const Professional = artifacts.require('./Professional_v6.sol');
...
contract('Legendary', (accounts) => {
    ...
    describe('Setting rate', async() => {
        ...
        //     const newEligibilityAmount = await instance.viewEligibilityAmount();
    ...
    describe('Staking', async() => {
        ...
        it('should not allow users to stake without eligibility from Rookie/Professional', async() => {
            ...
            await truffleAssert.reverts(instance.stake(stake.toString()), "Stake at least 5k tokens in the Rookie pool pr Professional")
        })
