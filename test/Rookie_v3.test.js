...
const Rookie = artifacts.require('./Rookie_v3.sol');
...
contract('Rookie', (accounts) => {
    ...
    describe('Staking', async() => {
        ...
        it('adds stakes', async() => {
            ...
            deposits[2].toString().should.equal(rate.toString(), "Rate is set correctly");
    ...
    describe('Withdraw', async() => {
        ...
        //     const stake = 2000000000000000000;
        //     await token.transfer(accounts[3], stake.toString());
        //     const balance = await token.balanceOf(accounts[3]);
        //     console.log(balance.toString());
        //     const stakedBalance = await instance.stakedBalance();
        //     const rewardBalance = await instance.rewardBalance();
        //     await token.approve(instance.address, stake.toString(), {from: accounts[3]});
        //     await instance.stake(stake.toString(), {from: accounts[3]});
        ...
        //     await timeout(30000);
        //     await instance._calculation(accounts[3], amount[2]);
        //     const newAmount = await instance.userDeposits({from: accounts[3]});
        //     console.log(newAmount[0].toString(), newAmount[2]);
        //     await timeout(60000);
        //     await instance.withdraw({from: accounts[3]});
        //     const reward = newAmount[0] - depositAmount;
        //     const balance1 = await token.balanceOf(accounts[3]);
        //     console.log(balance1.toString());
        //     //balance1.toString().should.equal((balance.add(web3.utils.toBN(reward)).toString()), "Equal");
